...
if (isset($_POST['action']) && $_POST['action'] == 'register') {
    ...
    if ($registration['value'] == '1') {
        ...
        $message = $auth->showMessage('warning', "Your can't register your account!");
    }
...
if (isset($_POST['action']) && $_POST['action'] == 'reset-password') {
    ...
    if ($options->forgot_password()['value'] === '1') {
        ...
        echo $auth->showMessage('warning', "You can't use this feature!");
    }
